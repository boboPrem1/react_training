export default function Todos() {
    return (
        <div className="w-1/4 py-3 px-4 flex flex-row-reverse justify-between bg-white/25 rounded-xl m-3">
            <div>
                <h1 className="mt-1 text-white">Juvanio Amouzougan's todos</h1>
